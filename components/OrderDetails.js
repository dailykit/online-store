  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.data}>
          <Text>
            {data.order.deliveryInfo.dropoff.dropoffInfo.customerAddress.line1 +
              ', ' +
              data.order.deliveryInfo.dropoff.dropoffInfo.customerAddress
                .line2 +
              ', ' +
              data.order.deliveryInfo.dropoff.dropoffInfo.customerAddress.city +
              ', ' +
              data.order.deliveryInfo.dropoff.dropoffInfo.customerAddress
                .state +
              ', ' +
      ...
      <View style={styles.row}>
        ...
        <View style={styles.data}>
          <Text>
            {data.order.deliveryInfo.dropoff.dropoffInfo.customerAddress.notes}
          </Text>
        </View>
      </View>
      <View style={styles.row}>
